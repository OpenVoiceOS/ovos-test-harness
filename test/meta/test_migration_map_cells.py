...
#: The pending-coverage set may only shrink; raised when a new twin is
#: intentionally parked with a new cell.
MAX_PENDING_TWINS = 18
...
def test_migration_twin_has_a_backcompat_cell(legacy):
    ...
    if legacy in _allowlist():
        ...
        pytest.xfail(
            ...
            f"this list. Self-flips to a hard "
