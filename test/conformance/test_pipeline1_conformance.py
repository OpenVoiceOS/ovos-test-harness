...
def setUpModule():
    ...
    try:
        ...
        register_padatious_intent(_MC.bus, GREET_INTENT, GREET_SAMPLES, skill_id=SKILL_ID)
        register_padatious_intent(_MC.bus, BOOM_INTENT, BOOM_SAMPLES, skill_id=SKILL_ID)
