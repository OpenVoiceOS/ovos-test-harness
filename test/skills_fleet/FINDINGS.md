...
gaps, which leaves **24 gaps out of 578 rows exercised**. See "A row of
...
### Coverage gaps (`coverage-gap`) — 24 rows (see correction note below)

24 reasonable paraphrases matched no fleet skill at all
